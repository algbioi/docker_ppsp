...
def createConfig(configPath, outFasta, toolsRoot, refRoot, pipelineDir):
...
def _main():
    ...
    inFastaList, outFasta, configPath, toolsRoot, refRoot, pipelineDir = sys.argv[1:7]
    ...
    if not os.path.isfile(configPath):
        createConfig(configPath, outFasta, toolsRoot, refRoot, pipelineDir)
